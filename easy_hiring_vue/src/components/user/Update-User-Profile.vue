      ...
      <v-col md="5">
        <v-card class="pa-6">
          ...
          <div>
            ...
            <v-text-field v-model="password" :rules="[rules.required, rules.min]" solo label="Change Password" clearable></v-text-field>
          </div>
          <div>
            <v-col cols="12" sm="6" md="4">
              <v-file-input v-model="image" solo label="Upload Image Image" chips required
